...
#s Phishing attack where the attacker could upload any extension file like
#.html or .exe
#a. For it, take a look at the submit_help() function in api.py in both secure and
#non-secure version 
